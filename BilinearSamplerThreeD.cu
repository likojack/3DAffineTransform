...
static int cunn_BilinearSamplerThreeD_updateOutput(lua_State *L)
{
...
static int cunn_BilinearSamplerThreeD_updateGradInput(lua_State *L)
{
  THCState *state = getCutorchState(L);
  THCudaTensor *inputImages = (THCudaTensor *)luaT_checkudata(L, 2, "torch.CudaTensor");
  THCudaTensor *grids = (THCudaTensor *)luaT_checkudata(L, 3, "torch.CudaTensor");
...
static int cunn_BilinearSamplerThreeD_updateGradInputOnlyGrid(lua_State *L)
{
  THCState *state = getCutorchState(L);
  THCudaTensor *inputImages = (THCudaTensor *)luaT_checkudata(L, 2, "torch.CudaTensor");
  THCudaTensor *grids = (THCudaTensor *)luaT_checkudata(L, 3, "torch.CudaTensor");
...
static const struct luaL_Reg cunn_BilinearSamplerThreeD__ [] = {
  {"BilinearSamplerThreeD_updateOutput", cunn_BilinearSamplerThreeD_updateOutput},
  {"BilinearSamplerThreeD_updateGradInput", cunn_BilinearSamplerThreeD_updateGradInput},
  {"BilinearSamplerThreeD_updateGradInputOnlyGrid", cunn_BilinearSamplerThreeD_updateGradInputOnlyGrid},
  {NULL, NULL}
};

static void cunn_BilinearSamplerThreeD_init(lua_State *L)
{
  luaT_pushmetatable(L, "torch.CudaTensor");
  luaT_registeratname(L, cunn_BilinearSamplerThreeD__, "nn");
  lua_pop(L,1);
}
